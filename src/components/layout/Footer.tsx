        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md leading-relaxed">
              Four friends, one vision. Building ventures that bring people
              together and create lasting experiences. From courts to concepts,
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                href="https://www.instagram.com/quadrant.ventures/"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/quadrant-ventures-22085b397/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-foreground hover:bg-primary hover:text-primary-foreground transition-all duration-300"
                aria-label="LinkedIn"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61584247736042"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-foreground hover:bg-primary hover:text-primary-foreground transition-all duration-300"
                aria-label="Facebook"
